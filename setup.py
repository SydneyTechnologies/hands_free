...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/init.launch.py', 'launch/control.launch.py', 'launch/nav.launch.py' , 'launch/mapping.launch.py']),
    ...
    entry_points={
        'console_scripts': [
            'controller = hands_free.MotionController:main',
            'state_publisher = hands_free.StatePublisher:main',
        ],
    },
)
